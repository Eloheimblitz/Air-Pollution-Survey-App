...
public class SurveyMapper {
    ...
    public SurveyResponse toResponse(SurveyRecord r) {
        return new SurveyResponse(
                ...
                r.getLatitude(), r.getLongitude(), r.getGpsAccuracy(), r.getHeadOfHouseholdName(), r.getContactNumber(),
                ...
                r.getPrimaryCookingFuel(), r.getSecondaryCookingFuel(), r.getCurrentSimpleCookingCategory(), r.getCookingLocation(),
                ...
                r.getSneezing(), r.getSoreThroat(), r.getColdOrFever(), r.getDryCough(), r.getPhlegmCough(), r.getWheezing(),
                r.getBreathlessness(), r.getChestDiscomfort(), r.getSleepDisturbance(), r.getHeadache(), r.getEyeIrritation(),
                r.getSkinIrritation(), r.getAsthma(), r.getInhalerUse(), r.getHeartProblems(), r.getDiabetes(), r.getHypertension(),
                ...
                r.getSelfVaccination(), r.getAnyChildUnderFiveInHousehold(), r.getChildVaccinationComplete(),
